...
- Slab-serif display typography with tight tracking, giving a refined, academic, intellectual feel.
- High-contrast surface switching — jumping immediately from cream canvas to pure dark `#181715` for product UI windows.
- Thin hairline borders (`{colors.hairline}`) used to structure grids, tables, and card outlines subtly.
