...
export const siteConfig = {
  ...
  address: process.env.NEXT_PUBLIC_ADDRESS || 'Số XX, Đường YY, Quận ZZ, TP.HCM',
  ...
  social: {
    ...
    tiktok: process.env.NEXT_PUBLIC_TIKTOK_URL || 'https://tiktok.com/@fpttelecom',
    zalo: process.env.NEXT_PUBLIC_ZALO_OA_URL || 'https://zalo.me/YOUR_ZALO_OA_ID',
  },
};
