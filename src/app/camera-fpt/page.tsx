...
export const metadata: Metadata = {
  ...
  description:
    'Camera FPT ứng dụng trí tuệ nhân tạo AI. Giải pháp an ninh thông minh cho gia đình và doanh nghiệp. Dữ liệu bảo mật tuyệt đối trên Cloud server Việt Nam.',
  alternates: {
  ...
  const cameraReviews = [
    {
      ...
      content:
        'Trước đây mình dùng thẻ nhớ hay bị lỗi mất dữ liệu. Từ ngày chuyển sang FPT Camera dùng Cloud, yên tâm tuyệt đối. Tốc độ xem lại trên điện thoại cực nhanh.',
      rating: 5,
      avatar: 'L',
    },
    {
      ...
      role: 'Dân văn phòng',
      content:
        'Tính năng khoanh vùng cảnh báo AI rất xịn. Ở công ty nhưng vẫn theo dõi được con nhỏ ở nhà, camera phân biệt được chó mèo nên không bị báo động giả.',
      rating: 5,
      avatar: 'H',
    },
    {
      ...
      role: 'Cán bộ hưu trí',
      content:
        'Trời mưa bão mà camera ngoài trời vẫn nét căng, đèn hồng ngoại chiếu xa sáng rực ban đêm. Nhân viên kỹ thuật xuống lắp đặt nhanh nhẹn, chu đáo.',
      rating: 5,
      avatar: 'T',
    },
  ];
  ...
  const cameraFaq = [
    {
      ...
      answer:
        'Lưu trữ Cloud (đám mây) giúp dữ liệu của bạn an toàn tuyệt đối 100%. Nếu không may có kẻ gian đột nhập lấy cắp hay đập phá Camera, bạn vẫn có thể xem lại toàn bộ hình ảnh trước đó trên điện thoại. Với thẻ nhớ, dữ liệu sẽ mất hoàn toàn.',
    },
    {
      question: 'Nhà tôi đang dùng mạng Viettel, VNPT thì có lắp được Camera FPT không?',
      answer:
        'Hoàn toàn được. Camera FPT hoạt động ổn định trên mọi nền tảng Internet của các nhà mạng khác nhau.',
    },
    {
      question: 'Bảo hành và bảo trì trong bao lâu?',
      answer:
        'Thiết bị Camera FPT được bảo hành chính hãng 24 tháng. Dịch vụ bảo trì và hỗ trợ kỹ thuật được miễn phí trọn đời trong suốt quá trình bạn sử dụng dịch vụ lưu trữ Cloud.',
    },
    {
      question: 'Khi mất điện Camera có hoạt động không?',
      answer:
        'Cũng giống như các loại camera thông thường, Camera FPT cần có nguồn điện để hoạt động. Nếu bạn muốn camera duy trì khi mất điện, có thể trang bị thêm bộ lưu điện (UPS) hoặc sử dụng nguồn dự phòng.',
    },
  ];
    ...
    <>
      ...
      <div className="dark:bg-background border-border/50 mt-12 border-t bg-slate-50 pt-12 pb-24">
        <div className="relative z-10 container mx-auto mb-[-60px] px-4 text-center">
          <h2 className="mb-4 text-3xl font-bold">Đăng Ký Tư Vấn & Khảo Sát Miễn Phí</h2>
          <p className="text-muted-foreground mx-auto max-w-2xl">
            Nhân viên kỹ thuật FPT sẽ xuống tận nơi khảo sát góc lắp đặt, độ sáng, tư vấn vị trí và
            số lượng camera phù hợp hoàn toàn miễn phí.
          </p>
        </div>
        <LeadForm />
      </div>
