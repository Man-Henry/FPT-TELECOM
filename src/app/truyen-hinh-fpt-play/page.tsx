...
export const metadata: Metadata = {
  ...
  description: 'Trải nghiệm truyền hình tương tác đỉnh cao cùng FPT Play. Độc quyền thể thao UEFA, V-League và kho phim bom tấn đặc sắc.',
  alternates: {
  ...
  const tvReviews = [
    {
      ...
      name: 'Thanh Hùng',
      role: 'Fan Bóng Đá',
      content: 'Gói Sport thực sự đáng tiền. Xem Cúp C1 mượt mà không lo giật lag như xem lậu, bình luận viên nhiệt huyết và hình ảnh 1080p sắc nét.',
      rating: 5,
      avatar: 'H'
    },
    {
      ...
      name: 'Ngọc Mai',
      role: 'Nội Trợ',
      content: 'Nhà có con nhỏ nên rất thích kho thiếu nhi của FPT Play. Nội dung được chọn lọc an toàn, có cả Netflix và Youtube tích hợp thẳng vào box, rất tiện lợi.',
      rating: 5,
      avatar: 'M'
    },
    {
      ...
      name: 'Văn Lâm',
      role: 'Dân Ghiền Phim',
      content: 'Đăng ký gói VIP được tặng kèm HBO Go là một món hời lớn. Xem phim bom tấn thả ga không có quảng cáo chen ngang, cuối tuần nào cũng như ở rạp.',
      rating: 5,
      avatar: 'L'
    }
  ];
  ...
  const tvFaq = [
    {
      ...
      answer: 'Hoàn toàn được. Khi đăng ký, FPT sẽ trang bị cho bạn thiết bị FPT Play Box (đầu thu thông minh) giúp biến mọi TV thường thành Smart TV, chỉ cần có cổng kết nối HDMI hoặc AV.'
    },
    {
      question: 'Một tài khoản FPT Play xem được bao nhiêu thiết bị cùng lúc?',
      answer: 'Tuỳ theo gói cước bạn đăng ký. Gói SPORT xem trên 1 thiết bị, gói MAX xem trên tối đa 3 thiết bị, và gói VIP hỗ trợ xem đồng thời lên đến 5 thiết bị.'
    },
    {
      question: 'Tôi đang dùng mạng Viettel/VNPT thì có đăng ký FPT Play được không?',
      answer: 'Được. FPT Play là ứng dụng độc lập, hoạt động mượt mà trên bất kỳ nền tảng mạng Internet nào của các nhà cung cấp khác.'
    },
    {
      question: 'Gói VIP khác gói MAX ở điểm nào?',
      answer: 'Gói VIP bao gồm toàn bộ quyền lợi của gói MAX, nhưng được ưu tiên xem hoàn toàn không có quảng cáo, tặng kèm kho phim HBO Go và K+, đồng thời tăng số lượng thiết bị đăng nhập cùng lúc lên 5 thiết bị.'
    }
  ];
      ...
      <div className="bg-slate-50 dark:bg-background pt-12 pb-24 border-t border-border/50 mt-12">
        <div className="container mx-auto px-4 text-center mb-[-60px] relative z-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Để lại số điện thoại, nhân viên FPT sẽ tư vấn gói cước truyền hình phù hợp và hỗ trợ trang bị đầu thu Tivi Box miễn phí tại nhà.
          </p>
        </div>
        <LeadForm />
      </div>
