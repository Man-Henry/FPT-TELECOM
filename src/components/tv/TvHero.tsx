  ...
  return (
    <section className="relative overflow-hidden bg-[#0A1128] pt-32 pb-20 text-white md:pt-40 md:pb-28">
      <div className="absolute inset-0 z-0">
        ...
        <Image src="/images/hero-truyen-hinh-fpt.jpg" alt="Truyền hình FPT Play" fill className="object-cover opacity-20" priority />
      </div>
      ...
      <div className="relative z-20 container mx-auto px-4 md:px-6">
        <Breadcrumb className="mb-8">
          <BreadcrumbList className="text-slate-500">
            ...
            <BreadcrumbItem><BreadcrumbPage className="font-semibold text-white">Truyền Hình FPT Play</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <div className="max-w-3xl">
          <div className="text-primary mb-6 inline-flex items-center rounded-md bg-white/[0.04] px-3 py-1 text-sm font-medium">
            <Play className="mr-2 h-4 w-4 fill-current" />Không Giới Hạn Giải Trí
          </div>

          <h1 className="mb-6 text-4xl leading-tight font-extrabold tracking-tight md:text-5xl lg:text-6xl">
            Thế Giới Giải Trí Đỉnh Cao Cùng{' '}
            <span className="text-primary">FPT Play</span>
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-6">
            <div className="flex items-center gap-2 text-slate-300">
              <CheckCircle2 className="text-primary/60 h-4 w-4" /><span className="text-sm">Gần 200 kênh</span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
              <CheckCircle2 className="text-primary/60 h-4 w-4" /><span className="text-sm">Xem trên 3 thiết bị</span>
            </div>
            <div className="flex items-center gap-2 text-slate-300">
              <CheckCircle2 className="text-primary/60 h-4 w-4" /><span className="text-sm">HBO Go, DANET</span>
            </div>
          </div>
        </div>
      </div>
