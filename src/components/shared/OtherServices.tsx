...
const services = [
  { name: 'Internet Cáp Quang', href: '/internet-cap-quang', icon: <Wifi className="h-5 w-5" />, description: 'Tốc độ siêu tốc, kết nối ổn định' },
  { name: 'Truyền Hình FPT Play', href: '/truyen-hinh-fpt-play', icon: <Tv className="h-5 w-5" />, description: 'Trực tiếp UEFA, hàng ngàn giờ phim' },
  { name: 'Camera Thông Minh', href: '/camera-fpt', icon: <Camera className="h-5 w-5" />, description: 'Cảnh báo AI, lưu trữ Cloud an toàn' },
  { name: 'Gói Combo Tiết Kiệm', href: '/goi-combo', icon: <Package className="h-5 w-5" />, description: 'Đa tiện ích trên một hoá đơn' },
];
...
export function OtherServices() {
  ...
  return (
    <section className="border-t border-white/[0.06] bg-background py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-12 text-center">
          <h2 className="text-foreground mb-4 text-3xl font-bold tracking-tight">Khám Phá Dịch Vụ Khác</h2>
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">Giải pháp công nghệ toàn diện từ FPT Telecom.</p>
        </div>
