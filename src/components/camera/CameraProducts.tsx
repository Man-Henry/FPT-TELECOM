...
const cameraProducts = [
  {
    name: 'Camera Trong Nhà (Indoor)', price: '800.000đ', originalPrice: '1.200.000đ',
    image: '/images/camera/camera-indoor-fpt.jpg',
    description: 'Thiết kế tinh tế, góc nhìn siêu rộng 102 độ, hỗ trợ đàm thoại 2 chiều.',
    features: ['Độ phân giải Full HD 1080p', 'Hồng ngoại ban đêm 10m', 'Kết nối Wi-Fi / LAN', 'Đàm thoại 2 chiều'],
    icon: <Wifi className="h-4 w-4" />,
  },
  {
    name: 'Camera Ngoài Trời (Outdoor)', price: '900.000đ', originalPrice: '1.300.000đ',
    image: '/images/camera/camera-outdoor-fpt.jpg',
    description: 'Bền bỉ trước mọi thời tiết. Chuẩn kháng nước, kháng bụi IP66.',
    features: ['Kháng nước IP66', 'Chống chịu nhiệt độ 75°C', 'Hồng ngoại ban đêm 20m', 'Cảnh báo thông minh AI'],
    popular: true, icon: <ShieldCheck className="h-4 w-4" />,
  },
  {
    name: 'Gói Lưu Trữ Cloud IQ', price: '44.000đ', originalPrice: '',
    image: '/images/camera/cloud-iq-fpt.jpg',
    description: 'Dữ liệu lưu trữ an toàn tuyệt đối trên server FPT tại Việt Nam.',
    features: ['Lưu trữ xem lại 3-7 ngày', 'Không lo mất dữ liệu do trộm/hỏng', 'Bảo mật 2 lớp an toàn', 'Nhận diện khuôn mặt AI'],
    ...
    <section className="bg-background py-24">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-16 text-center">
          <h2 className="text-foreground mb-4 text-3xl font-bold tracking-tight md:text-4xl">Camera Cho Mọi Nhu Cầu</h2>
          <p className="text-muted-foreground mx-auto max-w-2xl text-lg">Giám sát an ninh thông minh, lắp đặt nhanh chóng.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {cameraProducts.map((product, index) => (
            <div key={index} className={cn(
              ...
              product.popular ? 'border-primary/30 bg-[#0F1A2E]' : 'border-white/[0.06] bg-[#0C1524]',
            )}>
              {product.popular && (
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <p className="text-muted-foreground mb-4 min-h-[36px] text-sm">{product.description}</p>
                ...
                <a href="#dang-ky" className={cn(
                  ...
                  product.popular ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'border-white/[0.06] text-slate-300 hover:bg-white/[0.04]',
                )}>
                  Mua Ngay
                </a>
              </div>
