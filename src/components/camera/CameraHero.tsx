  ...
  return (
    <section className="relative overflow-hidden bg-[#0A1128] pt-32 pb-20 text-white md:pt-40 md:pb-28">
      <div className="absolute inset-0 z-0">
        ...
        <Image src="/images/hero-camera-fpt.jpg" alt="Camera An Ninh FPT" fill className="object-cover opacity-20" priority />
      </div>
      ...
      <div className="relative z-20 container mx-auto px-4 md:px-6">
        <Breadcrumb className="mb-8">
          <BreadcrumbList className="text-slate-500">
            ...
            <BreadcrumbItem><BreadcrumbPage className="font-semibold text-white">Camera FPT</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <div className="max-w-3xl">
          <div className="text-primary mb-6 inline-flex items-center rounded-md bg-white/[0.04] px-3 py-1 text-sm font-medium">
            <Camera className="mr-2 h-4 w-4" />Giải Pháp An Ninh
          </div>
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl text-lg md:text-xl">
            Công nghệ AI nhận diện khuôn mặt, cảnh báo thông minh. Lưu trữ mã hoá an toàn trên Cloud Việt Nam.
          </p>

          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:gap-8">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-white/[0.04] p-2.5 text-slate-400"><ShieldAlert className="h-5 w-5" /></div>
            ...
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-white/[0.04] p-2.5 text-slate-400"><Cloud className="h-5 w-5" /></div>
              <div className="flex flex-col">
